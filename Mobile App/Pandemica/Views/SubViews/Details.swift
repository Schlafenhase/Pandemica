            ...
            VStack {
                ...
                VStack {
                    Button(action: {
                        ...
                        PatientEditingView(patient: GRDBPersistable(self.patient, autoSave: false), showModal: self.$showModal)
                    }
                    Button(action: {
    ...
    var body: some View {
        ZStack {
            VStack() {
                ...
                Text("Nationality: \(contact.nationality)")
                Text("Address: \(contact.address)")
                Text("Pathologies: \(contact.pathologies)")
